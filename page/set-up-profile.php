<?php 
	...
	if( isset( $_POST['signup'] ) ) {
		...
		redirect_to( "set-up-profile.php" );
...
<html>
	<head>
		<meta charset="utf-8" />
		<title>E-Shop | Set Up your Profile </title>
					...
					<form class="form-horizontal" method="post">
						...
						<div class="modal-body">
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" class="form-control" name="uname" id="username" placeholder="Your Desired Username" required>
								</div>
							</div>
							<div class="form-group">
								<label for="firstname" class="col-lg-2 control-label">Password:</label>
								<div class="col-lg-10">
									<input type="password" class="form-control" name="pword" id="password" placeholder="Your Desired Password" required>
								</div>
							</div>	
						<div class="modal-footer">
